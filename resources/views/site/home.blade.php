...
@section('content')
    ...
    <ul>
        <li>🔭 Atualmente trabalhando na Teatech expandindo minha visão além do código, aplicando meus conhecimentos de
            gestão de pessoas para liderar e colaborar melhor em equipe.</li>
        <li>📘 Atualmente estudando na UNIT | Universidade Tiradentes</li>
        <li>🎯 Objetivo de carreira atual: Iniciar minha trajetória profissional no exterior, contribuindo com soluções
            criativas e escaláveis em projetos de impacto.</li>
        <li>⚡ Curiosidade: Adoro testar ferramentas novas e costumo perder horas me aventurando em novas ideias e features
        </li>
    </ul>
@endsection
